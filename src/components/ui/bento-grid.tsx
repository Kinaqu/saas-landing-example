...
export function BentoCard({ label, title, description, className, background, icon, ...props }: BentoCardProps) {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-linear-to-b from-white/10 via-white/5 to-white/80" />
      <div className="relative z-10 flex h-full flex-col justify-between p-6 md:p-7">
        ...
        <div className="max-w-sm space-y-3">
          ...
          <p className="text-sm leading-7 text-[rgba(16,32,51,0.68)]">{description}</p>
